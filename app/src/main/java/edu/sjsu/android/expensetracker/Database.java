...
public class Database extends SQLiteOpenHelper {
    ...
    public ExpenseClass getExpense(long id) {
        ...
        @SuppressLint("Range") String category = getCategoryByID(cursor.getLong(cursor.getColumnIndex(COLUMN_CATEGORY_ID)));
        // prepare note object
        @SuppressLint("Range") ExpenseClass expense = new ExpenseClass(
